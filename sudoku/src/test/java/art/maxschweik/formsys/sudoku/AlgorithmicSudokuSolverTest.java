...
class AlgorithmicSudokuSolverTest {
  ...
  void testWithLectureExample() {
    SudokuBoard lectureExample = new SudokuBoard(new SudokuNumber[][]{
    ...
    SudokuBoard lectureSolution = new SudokuBoard(new SudokuNumber[][]{
    ...
    System.out.println(lectureSolution);
